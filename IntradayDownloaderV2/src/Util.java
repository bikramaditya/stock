...
public class Util 
{
	...
	public boolean isMarketOpen() {
		...
		String startOff = "09:00 AM";
		String endOff = "03:35 PM";
		DateTimeFormatter timeParser = DateTimeFormatter.ofPattern("hh:mm a");
		LocalTime endOffTime = timeParser.parse(endOff, LocalTime::from);
		LocalDateTime endCutOffDateTime = LocalDateTime.of(currentDate, endOffTime);
		
		LocalTime startOffTime = timeParser.parse(startOff, LocalTime::from);
		LocalDateTime startOffDateTime = LocalDateTime.of(currentDate, startOffTime);
		
		if(currentDateTime.isAfter(startOffDateTime) && currentDateTime.isBefore(endCutOffDateTime))
		{
			return true;
		}
		else
