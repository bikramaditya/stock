...
public class ZerodhaConnect {
     ...
     * @param watchList */
    public Map<String, Quote> getQuote(KiteConnect kiteConnect, String[] watchList) throws KiteException, IOException {
        // Get quotes returns quote for desired tradingsymbol.
        //String[] instruments = {"256265","BSE:INFY", "NSE:APOLLOTYRE", "NSE:NIFTY 50"};
        Map<String, Quote> quotes = kiteConnect.getQuote(watchList);
        return quotes;
    }
