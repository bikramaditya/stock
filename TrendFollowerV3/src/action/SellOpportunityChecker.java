...
public class SellOpportunityChecker {
	...
	public SellOpportunityChecker(HistoricalDataEx lastMinus3,HistoricalDataEx lastMinus2, HistoricalDataEx lastMinus1, HistoricalDataEx lastCandle)
	{
	...
	{
		if(("2019-01-02 11:41:00".equals(lastCandle.timeStamp)) || ("2018-12-28 12:12:00".equals(lastCandle.timeStamp)))
		{
			System.out.println();
		}
